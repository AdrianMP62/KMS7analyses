...
rich.sums[NROW(rich.sums)+1, 2:46] <- colSums(rich.sums[grepl("cladocera|ostracoda|copepoda", rich.sums$LOWESTIDNC), 2:46])
rich.sums[NROW(rich.sums), 1] <- "microcrustacea"
rich.sums[NROW(rich.sums)+1, 2:46] <- colSums(rich.sums[grepl("amphipoda|shrimps|crabs", rich.sums$LOWESTIDNC), 2:46])
