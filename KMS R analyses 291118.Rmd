...
ggplot(rich.sums.list[rich.sums.list$sample %like% "1993|2003|2017-PB", ], aes(sample, richness, fill=factor(taxon,levels=c("protozoans","rotifers","other","molluscs","annelids","mites","microcrustacea","macrocrustacea","insects")))) + 
  scale_fill_brewer(palette="Set1") +  #use RColourBrewer package to set colours
  geom_bar(stat = "identity", colour="black") + #colour=black sets borders for the bars
