...
Spec.area <- data.frame("Species" = c(72,5,82,12,66,42,31,32,118,127)) #values are alternately number of species known from more than one area and then from just that area
